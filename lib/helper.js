...
Helper.to_satoshis = function (num_str) {
    // TODO validate number ranges and typeof(num_str)
    // num_str must be 8 decimal places or we'll get float issues
    return parseInt(Number(num_str) * Number("100000000"));
};
